...
module.exports = {
	...
	SCH: {
		abilities: ['Swiftcast', 'Lucid Dreaming', 'Surecast', 'Rescue', 'Lustrate', 'Excogitation', 'Sacred Soil', 'Indomitability', 'Emergency Tactics', 'Dissipation', 'Deployment Tactics', 'Recitation', 'Chain Stratagem', 'Aetherflow', 'Summon Seraph'], // TODO
		partyList: partyInfo.healer,
		fiftyDonation:'\r\nStop Healing Target ($50): \r\n'
	},
	DNC: {
		abilities: ['Leg Graze', 'Second Wind', 'Foot Graze', 'Peloton', 'Head Graze', 'Arm\'s Length', 'Shield Samba', 'Flourish', 'Improvisation', 'Devilment', 'En Avant', 'Closed Position', 'Saber Dance', 'Curing Waltz'], // TODO
